...
make SOC=evalsoc BOARD=nuclei_fpga_eval TOOLCHAIN=terapines      DOWNLOAD=ilm CORE=n300fd ITERATIONS=1 SIMULATION=1   STDCLIB=newlib_nano RISCV_ARCH=rv32imafdc RISCV_ABI=ilp32d clean run_qemu
